  ...
  return (
    (<div
      ...
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 text-black font-bold bg-gradient-to-r from-violet-500 via-pink-500 to-pink-300 bg-clip-text text-transparent max-w-4xl">
          Changelog from my journey{" "} ✨
        </h2>
        <p
          className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-sm">
          Check out my projects showcasing creativity 💡, code 🧑🏻‍💻, and cool design 🎨 solutions.
        </p>
      </div>
